...
export default async function statusV2({ statePath, flags }) {
  ...
  const explicitClaimedBy = flags["claimed-by"] || null;
  const claimedByFilter = mineActor && explicitClaimedBy && mineActor !== explicitClaimedBy
    ? "__no_matching_actor__"
    : mineActor || explicitClaimedBy;
